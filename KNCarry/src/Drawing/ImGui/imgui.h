...
// - To use something else than an opaque 
//  pointer: override with e.g. '#define ImTextureID MyTextureType*' in your imconfig.h file.
...
enum ImGuiCond_
{
    ...
    ImGuiCond_FirstUseEver  = 1 << 2,   // Set the variable if the objects/window has no persistently saved data (no entry in .ini file)
    ImGuiCond_Appearing     = 1 << 3,   // Set the variable if the objects/window is appearing after being hidden/inactive (or the first time)
};
